...
export default function Home() {
  return <main className="landing">
    <nav className="landing-nav"><Brand/><div className="nav-actions"><Link className="secondary" href="/login">Sign in</Link><Link className="primary" href="/demo">Open live demo</Link></div></nav>
    <section className="landing-hero">
      <div className="hero-copy"><span className="eyebrow">Personal finance, without the noise</span><h1>Clarity for <em>every rupee.</em></h1><p>Koshora turns transactions, budgets, recurring commitments and savings goals into one calm financial picture — then explains what changed and what may happen next.</p><div className="hero-cta"><Link className="primary" href="/demo">Explore recruiter demo</Link><Link className="secondary" href="/login">Create private workspace</Link></div><div className="hero-note">No bank credentials. Demo data stays in your browser. INR-first with Indian number formatting.</div></div>
